...
*)
    ...
    for option in phost proftpd vsftpd status snmpd dnate safephp change_id namp exim4 mysql nginx php wordpress typecho ssh addnginx cn us dhost vhost phost httpproxy eaccelerator  apache addapache sshport phpmyadmin
    do
        echo '  -' $option
    done
    ;;
